...
export const site: SiteData = { name: 'KK Furniture', description: 'Custom furniture', logo: '/assets/brand/logo-new.webp', heroVideo: '/assets/brand/hero.mp4', phone: '+37494000305', socials: { facebook: 'https://www.facebook.com/profile.php?id=100009769080688', viber: 'viber://chat?number=%2B37494000305', instagram: '#' } }
...
export const pages: Record<string, PageData> = {
  home: { id: 17, slug: 'home', title: { am: 'Գլխավոր', en: 'Home', ru: 'Главная', ir: 'خانه' }, content: {}, featuredImage: media('/assets/works/hyurasenyak/hyurasenyak-new10.webp'), gallery: works.map(item => item.featuredImage!).filter(Boolean), about: { titles: { title: 'Մեր մասին', title_en: 'About us', title_ru: 'О нас', title_ir: 'درباره ما' }, descriptions: { description: '<p>KKF-ը ստեղծում է անհատական կահույք՝ համադրելով ֆունկցիոնալությունը, որակը և ժամանակակից դիզայնը։ Յուրաքանչյուր նախագիծ սկսվում է ձեր տարածքից և ավարտվում մանրակրկիտ պատրաստված լուծմամբ։</p>', description_en: '<p>KKF creates custom furniture that combines functionality, quality and contemporary design. Every project begins with your space and ends with a carefully crafted solution.</p>', description_ru: '<p>KKF создаёт мебель на заказ, сочетая функциональность, качество и современный дизайн. Каждый проект начинается с вашего пространства и завершается тщательно продуманным решением.</p>', description_ir: '<p>KKF مبلمان سفارشی را با ترکیب کارایی، کیفیت و طراحی معاصر تولید می‌کند. هر پروژه از فضای شما آغاز می‌شود و با راهکاری دقیق و حرفه‌ای به پایان می‌رسد.</p>' }, image: media('/assets/works/hyurasenyak/hyurasenyak-new10.webp') } },
